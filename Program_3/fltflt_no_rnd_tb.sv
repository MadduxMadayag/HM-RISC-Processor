...
// load incoming operands into test DUT and your DUT
    ...
    t1.DM1.mem_core[9] = flt1[15:8];           // MSW of incoming flt
	t1.DM1.mem_core[8] = flt1[ 7:0];           // LSW of incoming flt
    t1.DM1.mem_core[11] = flt2[15:8];           // MSW of incoming flt
	t1.DM1.mem_core[10] = flt2[ 7:0];           // LSW of incoming flt
	#10ns req = 1;
	#10ns req = 0;
...
// read results from test DUT and your DUT
    ...
    flt3[15:8]      = t1.DM1.mem_core[13];		// your result upper bits
    flt3[ 7:0]      = t1.DM1.mem_core[12];
