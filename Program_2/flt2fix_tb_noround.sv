...
//    $monitor(flt_in,,,int_out);
  ...
  task disp();
    ...
    count++;
    if({f3.DM1.mem_core[7],f3.DM1.mem_core[6]} == {f2.data_mem1.mem_core[7],f2.data_mem1.mem_core[6]}) score0++;
    if(math == {f3.DM1.mem_core[7],f3.DM1.mem_core[6]}) score1++;
